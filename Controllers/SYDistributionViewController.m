...
#import "SYDistributionViewController.h"

@interface SYDistributionViewController ()<UITableViewDelegate,UITableViewDataSource,MLAMOrderDeliveryTableViewCellDelegate>
...
@implementation SYDistributionViewController

+ (instancetype)initDistributionVCFromNibFile {
    SYDistributionViewController *vc = [[UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"SYDistributionViewController"];
    return vc;
}
...
- (void)configTableView {
    ...
    self.tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        page = 0;
        [kSharedWebService fetchOrdersWithState:SYOrderStateInDelivery page:page completion:^(NSMutableArray *orders, BOOL didReachEnd, NSError *error) {
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        [kSharedWebService fetchOrdersWithState:SYOrderStateInDelivery page:page+1 completion:^(NSMutableArray *orders, BOOL didReachEnd, NSError *error) {
