...
#import "SYMapRouteViewController.h"

@interface SYMapRouteViewController ()<MAMapViewDelegate,UIAlertViewDelegate>
...
@implementation SYMapRouteViewController
+ (instancetype)instantiateFromStoryboard {
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle mainBundle]];
    SYMapRouteViewController *VC = [sb instantiateViewControllerWithIdentifier:@"SYMapRouteViewController"];
    return VC;
}
