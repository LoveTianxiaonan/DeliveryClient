...
NSDate *dateFromString(NSString *dateString) {
    NSDateFormatter *kFormatter;
    if (!kFormatter) {
        kFormatter = [[NSDateFormatter alloc] init];
        [kFormatter setTimeZone:[NSTimeZone timeZoneWithName:@"UTC"]];
        [kFormatter setDateFormat:@"yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"];
    }
    
    return [kFormatter dateFromString:dateString];
}
...
- (NSString *)humanDateStringWithDashFormat {
    static NSDateFormatter *dateFormatter;
    if (!dateFormatter) {
        dateFormatter = [[NSDateFormatter alloc] init];
        dateFormatter.dateFormat = @"yyyy-MM-dd";
